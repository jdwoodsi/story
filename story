THIS IS A BACKUP OF STORY (as a new story file was created from line 2 onwards, so the first line commit history is saved here); Story.txt is the proper file:
